...
abstract class MobilpayPaymentRequestAbstract
{
	...
	{
		/**
		 * The commented lines On Php 8.2.1 time to time recived error "Deprecated: Implicit conversion,..."
		 */
		// srand((double) microtime() * 1000000);
        // $this->_requestIdentifier = md5(uniqid(rand()));

		/**
		 * The folowing lines are solution of "Deprecated: Implicit conversion,..." Error
		 */
		$microtime = microtime();
